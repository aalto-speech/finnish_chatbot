...
if "csv" in evaluation_file_extension:
    ...
    metrics = calculate_evaluation_metrics("temp_evalution.csv", voc, encoder, decoder, embedding, 10, 5, "¤", device)

print('The results are r@k: {0}, N-choose-k: {1}, ppl: {2}, char ppl: {3}, BLEU: {4}'.format(metrics[0], metrics[1], metrics[2], metrics[3], metrics[4]))
